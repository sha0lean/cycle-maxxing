...
- [?] **Intégration sprites avatar dans l'app** — détourage (fond transparent) des sprites générés hors-repo, puis affichage gamifié + animation par fondu entre états au survol de la frise (cf. `prompts/avatar/characters/julie/animation.md`). Émergé session 29 juin 2026. Dépend de : génération des 10 sprites Julie (process figé en D_008).
- [?] **Toggle avatar Remy (Easter egg)** — bascule l'avatar affiché de Julie vers Remy, qui reprend les mêmes poses/états. Pur fun. Émergé session 29 juin 2026. Dépend de : `characters/remy/bible.json` rempli + sprites Remy générés.
